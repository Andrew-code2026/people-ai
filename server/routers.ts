...
import { createHiring, createPosition, createTemplate, generateLink, getDocumentUrl, getHiringDetail, getPortal, listHiring, listPositions, listTemplates, listNotifications, removePortalDocument, submitPortal, updateRequirement, updateTemplate, uploadPortalDocument } from "./hrDomain";
