    ...
    <div className="min-h-screen bg-[#f7f9fc] text-slate-900">
      ...
      <div className="mx-auto flex max-w-[1440px]">
        ...
        <main className="min-w-0 flex-1 px-4 py-6 sm:px-6 lg:px-10 lg:py-8">
          <div className="mb-8 flex flex-col justify-between gap-5 lg:flex-row lg:items-end"><div><p className="mb-2 text-xs font-semibold uppercase tracking-[0.2em] text-blue-600">{config.eyebrow}</p><h1 className="max-w-3xl text-3xl font-semibold tracking-[-0.04em] text-slate-950 sm:text-4xl">{config.title}</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">{config.description}</p></div><Button onClick={() => startLogin()} className="w-full bg-slate-950 text-white shadow-lg shadow-slate-950/10 hover:bg-slate-800 sm:w-auto"><LockKeyhole className="mr-2 h-4 w-4" />Iniciar sesión</Button></div>
